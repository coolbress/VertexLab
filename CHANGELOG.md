...
## [1.0.1](https://github.com/coolbress/VertexLab/compare/vertex-lab-v1.0.0...vertex-lab-v1.0.1) (2026-03-31)
...
> Note: v0.2.0 marks the boundary of pre-release consolidated history. The entries below retain only root meta-package and repository-level changes; package-specific history is tracked in component changelogs.
