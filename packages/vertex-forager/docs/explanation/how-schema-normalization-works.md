...
If no schema is registered for a table, the mapper emits a warning, passes the frame through unchanged, and increments the `schema_unknown_table_count` counter.
