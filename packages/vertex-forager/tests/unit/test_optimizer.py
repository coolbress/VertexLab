...
class TestOptimizedBulkCalculator:
    ...
    def test_heuristic_bulk_packing_returns_chunks(self, optimizer: OptimizedBulkCalculator) -> None:
    ...
    def test_optimize_without_metadata_falls_back_to_heuristic(self, optimizer: OptimizedBulkCalculator) -> None:
    ...
    def test_optimize_with_missing_columns_falls_back_to_heuristic(self, optimizer: OptimizedBulkCalculator) -> None:
    ...
    def test_optimize_with_valid_metadata_packs_bulks(self, optimizer: OptimizedBulkCalculator) -> None:
    ...
    def test_optimize_splits_large_bulks(self, optimizer: OptimizedBulkCalculator) -> None:
