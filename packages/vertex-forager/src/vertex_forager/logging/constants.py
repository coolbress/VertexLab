...
LOG_AUTH_CREDENTIAL_MASKED: Final[str] = "{prefix}: Auth credential={masked}"
...
LOG_BATCH_FORCE_SINGLE: Final[str] = (
    "{prefix}: Forcing single-symbol job for {symbol} (est_rows={est_rows} > max_rows={max_rows})"
)
